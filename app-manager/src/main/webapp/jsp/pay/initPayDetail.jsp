...
<head>
    ...
    <script type="text/javascript" src="<%=syspath%>/js/payDetail.js"></script>
</head>
<body>
<input type="hidden" id="payId" name="payId" value="${itemObj.id }"/>
<input type="hidden" id="payMonth" name="payMonth"
       value="<fmt:formatDate value="${itemObj.payMonth }" pattern="yyyy年MM月" />">
<input type="hidden" id="projectsName" name="projectsName" value="${itemObj.projectsName }">
