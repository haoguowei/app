Ext.onReady(function () {
    ...
    var urlEditValid = "initOtherCostEdit.do";

    //是否有权限
    var isPRISaveMember = isHavePRI("saveOtherCost.do");//新增编辑用户
    ...
    this.updateF = function (id) {
        location.href = "initOtherCostEdit.do?id=" + id;
    };
    ...
    var grid = new com.custom.GridPanel({
        ...
        columns: [
            ...
            {width: 3, header: '消费费用(元)', align: 'right', sortable: false, dataIndex: 'payAmount'},
